...
if(isset($_REQUEST['mode']))
{
	...
	{
		// Version-aware multicall keeps compatibility across rTorrent releases (multicall vs multicall2).
		$mcCmd = getCmd("d.multicall");
		$req = new rXMLRPCRequest( new rXMLRPCCommand($mcCmd, array("",getCmd("d.get_custom1="))) );
		$labels = array();
