...
- PHP 8.5 with the IvanShift/ruTorrent fork pinned to `d7f16f9d2e7ddff9814c2b843e184cba618b87bb`, rTorrent/libtorrent 0.16.20, Alpine-provided c-ares, and UnRAR 7.23 built from RARLab's `unrarsrc-7.2.7.tar.gz`
...
| `RUTORRENT_REF` | ruTorrent fork ref fetched and checked out detached | optional | `d7f16f9d2e7ddff9814c2b843e184cba618b87bb` |
