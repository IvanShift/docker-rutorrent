...
- PHP 8.5 with the IvanShift/ruTorrent fork pinned to `ff285b3e3b307ec3b263a999d26d2d7974c038bb`, rTorrent/libtorrent 0.16.20, Alpine-provided c-ares, and UnRAR 7.23 built from RARLab's `unrarsrc-7.2.7.tar.gz`
...
| `RUTORRENT_REF` | ruTorrent fork ref fetched and checked out detached | optional | `ff285b3e3b307ec3b263a999d26d2d7974c038bb` |
