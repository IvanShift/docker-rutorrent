...
- PHP 8.5 with the IvanShift/ruTorrent fork from its `master` branch, rTorrent/libtorrent 0.16.15, c-ares 1.34.6, and UnRAR 7.2.6
...
| `LIBTORRENT_BRANCH` | libtorrent release tag used for source checkout | optional | `v0.16.15` |
| `RTORRENT_BRANCH` | rTorrent release tag used for source checkout | optional | `v0.16.15` |
