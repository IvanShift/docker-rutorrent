...
- PHP 8.5 with the IvanShift/ruTorrent fork pinned to `ef49ef649b57f8fea75b19b0c8514a1d4a138827`, rTorrent/libtorrent 0.16.20, Alpine-provided c-ares, and UnRAR 7.23 built from RARLab's `unrarsrc-7.2.7.tar.gz`
...
| `RUTORRENT_REF` | ruTorrent fork ref fetched and checked out detached | optional | `ef49ef649b57f8fea75b19b0c8514a1d4a138827` |
