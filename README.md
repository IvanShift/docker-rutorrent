...
- PHP 8.5 with the IvanShift/ruTorrent fork from its `master` branch, rTorrent/libtorrent 0.16.16, c-ares 1.34.6, and UnRAR 7.2.7
...
| `LIBTORRENT_BRANCH` | libtorrent release tag used for source checkout | optional | `v0.16.16` |
| `RTORRENT_BRANCH` | rTorrent release tag used for source checkout | optional | `v0.16.16` |
