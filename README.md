...
- PHP 8.5 with the IvanShift/ruTorrent fork pinned to `81123b6a5eb01d845181fdce7154e113fb6139c5`, rTorrent/libtorrent 0.16.20, Alpine-provided c-ares, and UnRAR 7.23 built from RARLab's `unrarsrc-7.2.7.tar.gz`
...
| `RUTORRENT_REF` | ruTorrent fork ref fetched and checked out detached | optional | `81123b6a5eb01d845181fdce7154e113fb6139c5` |
